          ...
          <form className="d-flex me-md-5" role="search">
            ...
            <div className="dropdown">
              {localStorage.getItem("token") != null ? <> <a className="btn" href="#" role="button" data-bs-toggle="dropdown">
                <img className='navbar-profile-pic' alt="profile pic" src="https://plus.unsplash.com/premium_photo-1681426478241-11b262dd1d21?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
              </a>
